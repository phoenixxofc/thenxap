...
export interface ArenaDashLedgerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOf"
      | "balanceOfBatch"
...
export namespace ScoreSubmittedEvent {
  ...
  export type OutputTuple = [player: string, score: bigint, season: bigint];
  export interface OutputObject {
    player: string;
    score: bigint;
    season: bigint;
...
export interface ArenaDashLedger extends BaseContract {
  connect(runner?: ContractRunner | null): ArenaDashLedger;
  waitForDeployment(): Promise<this>;

  interface: ArenaDashLedgerInterface;
  ...
  submitScore: TypedContractMethod<
    [_score: BigNumberish, _timestamp: BigNumberish, _signature: BytesLike],
    [void],
    "nonpayable"
  >;
